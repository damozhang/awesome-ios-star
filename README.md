...
- [RxFlow](https://github.com/RxSwiftCommunity/RxFlow) [★ 1499] - Navigation framework for iOS applications based on a Reactive Flow Coordinator pattern.
...
- [RouteComposer](https://github.com/ekazaev/route-composer) [★ 399] - Library that helps to handle view controllers composition, routing and deeplinking tasks.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [★ 2192] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [Bitcoin-Swift-Kit](https://github.com/horizontalsystems/bitcoin-kit-ios) [★ 143] - Full Bitcoin library written on Swift. Complete SPV wallet implementation for Bitcoin, Bitcoin Cash and Dash blockchains.
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [★ 13651] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [HanekeSwift](https://github.com/Haneke/HanekeSwift) [★ 5100] - A lightweight generic cache for iOS written in Swift with extra love for images.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [★ 33358].
...
- [MLeaksFinder](https://github.com/Tencent/MLeaksFinder) [★ 5066] - Find memory leaks in your iOS app at develop time.
...
- [FBRetainCycleDetector](https://github.com/facebook/FBRetainCycleDetector) [★ 3895] - iOS library to help detecting retain cycles in runtime.
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [★ 4764] - A code library and command-line formatting tool for reformatting Swift code.
...
- [DKNightVersion](https://github.com/Draveness/DKNightVersion) [★ 3540] - Manage Colors, Integrate Night/Multiple Themes.
...
- [Realm](https://github.com/realm/realm-cocoa) [★ 14471] - The alternative to CoreData and SQLite: Simple, modern and fast.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [★ 3943] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [MMKV](https://github.com/Tencent/MMKV) [★ 12655] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [BTree](https://github.com/attaswift/BTree) [★ 1216] - Fast ordered collections for Swift using in-memory B-trees.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [★ 24902] - Algorithms and data structures in Swift, with explanations!
...
- [DeepDiff](https://github.com/onmyway133/DeepDiff) [★ 1895] - Diff in Swift.
...
- [KeyPathKit](https://github.com/vincent-pradeilles/KeyPathKit) [★ 383] - KeyPathKit provides a seamless syntax to manipulate data using typed keypaths.
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) [★ 6370] - The best way to manage Dates and Timezones in Swift.
...
- [TrueTime](https://github.com/instacart/TrueTime.swift) [★ 470] - Get the true current time impervious to device clock time changes.
...
- [Flex](https://github.com/Flipboard/FLEX) [★ 12335] - An in-app debugging and exploration tool for iOS.
...
- [Hyperion](https://github.com/willowtreeapps/Hyperion-iOS) [★ 1899] - In-app design review tool to inspect measurements, attributes, and animations.
...
- [DoraemonKit](https://github.com/didi/DoraemonKit) [★ 17335] - A full-featured iOS App development assistant，30+ tools included. You deserve it. 
...
- [PromiseKit](https://github.com/mxcl/PromiseKit) [★ 13392] - Promises for iOS and macOS.
...
- [FileProvider](https://github.com/amosavian/FileProvider) [★ 741] - FileManager replacement for Local, iCloud and Remote (WebDAV/FTP/Dropbox/OneDrive/SMB2) files on iOS/tvOS and macOS.
...
- [CameraManager](https://github.com/imaginary-cloud/CameraManager) [★ 1153] - Simple Swift class to provide all the configurations you need to create custom camera view in your app.
...
- [SwiftLocation](https://github.com/malcommac/SwiftLocation) [★ 2925] - Location & Beacon Monitoring in Swift.
...
- [SnapKit](https://github.com/SnapKit/SnapKit) [★ 17521] - A Swift Autolayout DSL for iOS & macOS.
...
- [MyLinearLayout](https://github.com/youngsoft/MyLinearLayout) [★ 4080] - MyLayout is a powerful iOS UI framework implemented by Objective-C. It integrates the functions with Android Layout,iOS AutoLayout,SizeClass, HTML CSS float and flexbox and bootstrap.
...
- [PinLayout](https://github.com/layoutBox/PinLayout) [★ 1724] - Fast Swift Views layouting without auto layout. No magic, pure code, full control and blazing fast. Concise syntax, intuitive, readable & chainable.
...
- [FlexLayout](https://github.com/layoutBox/FlexLayout) - FlexLayout gently wraps the highly optimized [facebook/yoga](https://github.com/facebook/yoga) [★ 14333] flexbox implementation in a concise, intuitive & chainable syntax.
...
- [YogaKit](https://github.com/facebook/yoga/tree/master/YogaKit) [★ 14333] - Powerful layout engine which implements Flexbox.
...
- [Localize-Swift](https://github.com/marmelroy/Localize-Swift) [★ 2641] - Swift 2.0 friendly localization and i18n with in-app language switching.
...
- [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) [★ 12382] - A fast & simple, yet powerful & flexible logging framework for Mac and iOS.
...
- [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) [★ 156051] - The official Google-built powerful neural network library port for iOS.
...
- [CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) [★ 5019] - A collection of unique Core ML Models.
...
- [Mapbox GL](https://github.com/mapbox/mapbox-gl-native) [★ 4002] - An OpenGL renderer for Mapbox Vector Tiles with SDK bindings for iOS.
...
- [Porcupine](https://github.com/Picovoice/Porcupine) [★ 2442] - On-device wake word detection engine for macOS, iOS, and watchOS, powered by deep learning.
...
- [APNGKit](https://github.com/onevcat/APNGKit) [★ 1771] - High performance and delightful way to play with APNG format in iOS.
...
### Image
- [GPU Image](https://github.com/BradLarson/GPUImage) [★ 19745] - An open source iOS framework for GPU-based image and video processing.
...
- [Nuke](https://github.com/kean/Nuke) [★ 6050] - Image loading, processing, caching and preheating.
...
- [Kingfisher](https://github.com/onevcat/Kingfisher) [★ 18447] - A lightweight and pure Swift implemented library for downloading and caching image from the web.
...
- [QRCode](https://github.com/aschuch/QRCode) [★ 700] - A QRCode generator written in Swift.
...
- [MobilePlayer](https://github.com/mobileplayer/mobileplayer-ios) [★ 2895] - A powerful and completely customizable media player for iOS.
- [XCDYouTubeKit](https://github.com/0xced/XCDYouTubeKit) [★ 2805] - YouTube video player for iOS, tvOS and macOS.
...
- [ZFPlayer](https://github.com/renzifeng/ZFPlayer) [★ 6564] - Based on AVPlayer, support for the horizontal screen, vertical screen (full screen playback can also lock the screen direction), the upper and lower slide to adjust the volume, the screen brightness, or so slide to adjust the playback progress.
...
- [Alamofire](https://github.com/Alamofire/Alamofire) [★ 35746] - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
...
- [Moya](https://github.com/Moya/Moya) [★ 13045] - Network abstraction layer written in Swift.
...
- [apollo-ios](https://github.com/apollographql/apollo-ios) [★ 2977] - A GraphQL client for iOS.
...
- [swift-protobuf](https://github.com/apple/swift-protobuf) [★ 3480] - Plugin and runtime library for using protobuf with Swift.
...
- [PEM](https://github.com/fastlane/fastlane/tree/master/pem) [★ 32343] - Automatically generate and renew your push notification profiles.
...
- [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) [★ 20570] - The better way to deal with JSON data in Swift.
- [FastEasyMapping](https://github.com/Yalantis/FastEasyMapping) [★ 557] - Serialize & deserialize JSON fast.
- [ObjectMapper](https://github.com/tristanhimmelman/ObjectMapper) [★ 8752] - A framework written in Swift that makes it easy for you to convert your Model objects (Classes and Structs) to and from JSON.
...
- [RxSwift](https://github.com/ReactiveX/RxSwift) [★ 20147] - Reactive Programming in Swift.
...
- [ReSwift](https://github.com/ReSwift/ReSwift) [★ 6901] - Unidirectional Data Flow in Swift - Inspired by Redux.
...
- [Katana](https://github.com/BendingSpoons/katana-swift) [★ 2109] - Swift apps a la React and Redux.
...
- [Runtime](https://github.com/wickwirew/Runtime) [★ 776] - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.
