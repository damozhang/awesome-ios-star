...
- [RxFlow](https://github.com/RxSwiftCommunity/RxFlow) [:star: 1790] - Navigation framework for iOS applications based on a Reactive Flow Coordinator pattern.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4897] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9643] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [:star: 14187] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 36816].
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6988] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17770] - A tool to enforce Swift style and conventions.
...
- [Hue](https://github.com/zenangst/Hue) [:star: 3435] - Hue is the all-in-one coloring utility that you'll ever need.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6164] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) [:star: 3072] - A collaborative list of Parse alternative backend service providers.
...
- [IceCream](https://github.com/caiyue1993/IceCream) [:star: 1875] - Sync Realm Database with CloudKit.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16189] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 28044] - Algorithms and data structures in Swift, with explanations!
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) [:star: 7425] - The best way to manage Dates and Timezones in Swift.
...
- [Playbook](https://github.com/playbook-ui/playbook-ios) [:star: 1037] - A library for isolated developing UI components and automatically snapshots of them.
...
- [CameraManager](https://github.com/imaginary-cloud/CameraManager) [:star: 1314] - Simple Swift class to provide all the configurations you need to create custom camera view in your app.
...
- [NextLevel](https://github.com/NextLevel/NextLevel) [:star: 2095] - Next Level is a media capture camera library for iOS.
...
- [FlexLayout](https://github.com/layoutBox/FlexLayout) - FlexLayout gently wraps the highly optimized [facebook/yoga](https://github.com/facebook/yoga) [:star: 16437] flexbox implementation in a concise, intuitive & chainable syntax.
...
- [YogaKit](https://github.com/facebook/yoga/tree/master/YogaKit) [:star: 16437] - Powerful layout engine which implements Flexbox.
...
- [Grid](https://github.com/exyte/Grid) [:star: 1487] - The most powerful Grid container missed in SwiftUI.
...
- [Pulse](https://github.com/kean/Pulse) [:star: 5535] - Pulse is a powerful logging system for Apple Platforms. Native. Built with SwiftUI.
...
- [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) [:star: 177733] - The official Google-built powerful neural network library port for iOS.
...
- [CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) [:star: 5949] - A collection of unique Core ML Models.
...
- [AudioKit](https://github.com/audiokit/AudioKit) [:star: 10056] - A powerful toolkit for synthesizing, processing, and analyzing sounds.
...
- [SwiftyGif](https://github.com/kirualex/SwiftyGif) [:star: 1819] - High performance GIF engine.
...
- [Nuke](https://github.com/kean/Nuke) [:star: 7529] - Image loading, processing, caching and preheating.
...
- [Kingfisher](https://github.com/onevcat/Kingfisher) [:star: 21609] - A lightweight and pure Swift implemented library for downloading and caching image from the web.
...
### Streaming
- [HaishinKit.swift](https://github.com/shogo4405/HaishinKit.swift) [:star: 2574] - Camera and Microphone streaming library via RTMP, HLS for iOS, macOS.
...
- [ZFPlayer](https://github.com/renzifeng/ZFPlayer) [:star: 6968] - Based on AVPlayer, support for the horizontal screen, vertical screen (full screen playback can also lock the screen direction), the upper and lower slide to adjust the volume, the screen brightness, or so slide to adjust the playback progress.
...
- [ExyteChat](https://github.com/exyte/Chat) [:star: 265] - SwiftUI Chat UI framework with fully customizable message cells, input view, and a built-in media picker.
...
- [Alamofire](https://github.com/Alamofire/Alamofire) [:star: 39788] - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
...
- [swift-protobuf](https://github.com/apple/swift-protobuf) [:star: 4297] - Plugin and runtime library for using protobuf with Swift.
...
- [PEM](https://github.com/fastlane/fastlane/tree/master/pem) [:star: 37532] - Automatically generate and renew your push notification profiles.
- [Knuff](https://github.com/KnuffApp/Knuff) [:star: 5213] - The debug application for Apple Push Notification Service (APNS).
...
- [NetNewsWire](https://github.com/Ranchero-Software/NetNewsWire) [:star: 7179] - It’s a free and open-source feed reader for macOS and iOS.
...
- [SPPermissions](https://github.com/ivanvorobei/SPPermissions) [:star: 5345] - Ask permissions on Swift. Available List, Dialog & Native interface. Can check state permission.

## Reactive Programming
- [RxSwift](https://github.com/ReactiveX/RxSwift) [:star: 23575] - Reactive Programming in Swift.
...
- [ReSwift](https://github.com/ReSwift/ReSwift) [:star: 7455] - Unidirectional Data Flow in Swift - Inspired by Redux.
...
- [RxCoordinator](https://github.com/quickbirdstudios/XCoordinator) [:star: 2109] -  Powerful navigation library for iOS based on the coordinator pattern.
...
- [Vapor](https://github.com/vapor/vapor) [:star: 23186] - Elegant web framework for Swift that works on iOS, macOS, and Ubuntu.
...
- [GCDWebServer](https://github.com/swisspol/GCDWebServer) [:star: 6404] - Lightweight GCD based HTTP server for macOS & iOS (includes web based uploader & WebDAV server).
...
- [SwiftRichString](https://github.com/malcommac/SwiftRichString) [:star: 2976] - Elegant & Painless Attributed Strings Management Library in Swift.
...
- [Down](https://github.com/iwasrobbed/Down) [:star: 2120] - Blazing fast Markdown rendering in Swift, built upon cmark.
...
- [ViewInspector](https://github.com/nalexn/ViewInspector) [:star: 1783] - Runtime inspection and unit testing of SwiftUI views
...
- [SnapshotTesting](https://github.com/pointfreeco/swift-snapshot-testing) [:star: 3343] - Delightful Swift snapshot testing.
...
- [SwiftTheme](https://github.com/wxxsw/SwiftTheme) [:star: 2452] - Powerful theme/skin manager for iOS.
