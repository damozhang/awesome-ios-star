...
- [RxFlow](https://github.com/RxSwiftCommunity/RxFlow) [:star: 1780] - Navigation framework for iOS applications based on a Reactive Flow Coordinator pattern.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4776] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
- [CleanArchitectureRxSwift](https://github.com/sergdort/CleanArchitectureRxSwift) [:star: 3715] - Example of Clean Architecture of iOS app using RxSwift.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9233] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 36692].
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17591] - A tool to enforce Swift style and conventions.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6067] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) [:star: 3031] - A collaborative list of Parse alternative backend service providers.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16044] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 27949] - Algorithms and data structures in Swift, with explanations!
...
- [chisel](https://github.com/facebook/chisel) [:star: 9010] - Collection of LLDB commands to assist debugging iOS apps.
...
- [Hydra](https://github.com/malcommac/Hydra) [:star: 1977] - Promises & Await - Write better async code in Swift.
