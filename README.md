...
Please see [CONTRIBUTING](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md) and [CODE-OF-CONDUCT](https://github.com/vsouza/awesome-ios/blob/master/CODE_OF_CONDUCT.md) [:star: 45516] for details.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 5350] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 11038] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [Cache](https://github.com/hyperoslo/Cache) [:star: 2879] - Nothing but Cache.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 37200].
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 7441] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 18246] - A tool to enforce Swift style and conventions.
...
- [ModuleInterface](https://github.com/minuscorp/ModuleInterface) [:star: 80] - Command Line Tool that generates the Module's Interface from a Swift project.
...
- [Realm](https://github.com/realm/realm-cocoa) [:star: 16110] - The alternative to CoreData and SQLite: Simple, modern and fast.
...
- [SQLite.swift](https://github.com/stephencelis/SQLite.swift) [:star: 9426] - A type-safe, Swift-language layer over SQLite3.
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6435] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) [:star: 3198] - A collaborative list of Parse alternative backend service providers.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16728] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
- [Defaults](https://github.com/sindresorhus/Defaults) [:star: 1796] - Swifty and modern UserDefaults.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 28399] - Algorithms and data structures in Swift, with explanations!
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) [:star: 7509] - The best way to manage Dates and Timezones in Swift.
...
- [DateHelper](https://github.com/melvitax/DateHelper) [:star: 1460] - Convenience extension for NSDate in Swift.
...
- [Chronology](https://github.com/davedelong/Chronology) [:star: 2255] - Building a better date/time library.
...
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 19905] - A full-featured iOS App development assistant，30+ tools included. You deserve it.
- [Atlantis](https://github.com/ProxymanApp/atlantis) [:star: 1150] - A little and powerful iOS framework for intercepting HTTP/HTTPS Traffic from your iOS app. No more messing around with proxy and certificate config. Inspect Traffic Log with Proxyman app.
...
- [SwiftFortuneWheel](https://github.com/sh-khashimov/SwiftFortuneWheel) [:star: 325] - A cross-platform framework for games like a Wheel of Fortune.
