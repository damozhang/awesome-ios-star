...
Please see [CONTRIBUTING](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md) and [CODE-OF-CONDUCT](https://github.com/vsouza/awesome-ios/blob/master/CODE_OF_CONDUCT.md) :star: 47445 for details.
...
- [DeepLinkKit](https://github.com/button/DeepLinkKit) :star: 3448 - A splendid route-matching, block-based way to handle your deep links.
...
- [URLNavigator](https://github.com/devxoul/URLNavigator) :star: 3259 - Elegant URL Routing for Swift
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) :star: 5835 - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) :star: 12586 - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [ARHeadsetKit](https://github.com/philipturner/ARHeadsetKit) :star: 124 - High-level framework for using $5 Google Cardboard to replicate
 Microsoft Hololens.
- [ARKit-CoreLocation](https://github.com/ProjectDent/ARKit-CoreLocation) :star: 5479 - Combines the high accuracy of AR with the scale of GPS data.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) :star: 37649.
...
- [Inject](https://github.com/krzysztofzablocki/Inject) :star: 2346 - Hot Reloading for Swift applications!
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) :star: 7955 - A code library and command-line formatting tool for reformatting Swift code.
...
- [OCLint](https://github.com/oclint/oclint) :star: 3781 - Static code analysis tool for improving quality and reducing defects.
- [Swiftlint](https://github.com/realm/SwiftLint) :star: 18700 - A tool to enforce Swift style and conventions.
...
- [Realm](https://github.com/realm/realm-cocoa) :star: 16336 - The alternative to CoreData and SQLite: Simple, modern and fast.
...
- [SwiftyUserDefaults](https://github.com/sunshinejr/SwiftyUserDefaults) :star: 4871 - Statically-typed NSUserDefaults.
- [SugarRecord](https://github.com/modo-studio/SugarRecord) :star: 2110  - Data persistence management library.
- [SQLite.swift](https://github.com/stephencelis/SQLite.swift) :star: 9742 - A type-safe, Swift-language layer over SQLite3.
- [GRDB.swift](https://github.com/groue/GRDB.swift) :star: 6943 - A versatile SQLite toolkit for Swift, with WAL mode support.
- [Fluent](https://github.com/vapor/fluent) :star: 1328 - Simple ActiveRecord implementation for working with your database in Swift.
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) :star: 3293 - A collaborative list of Parse alternative backend service providers.
...
- [WCDB](https://github.com/Tencent/wcdb) :star: 10850 - WCDB is an efficient, complete, easy-to-use mobile database framework for iOS, macOS.
...
- [MMKV](https://github.com/Tencent/MMKV) :star: 17467 - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
- [Defaults](https://github.com/sindresorhus/Defaults) :star: 2039 - Swifty and modern UserDefaults.
- [MongoKitten](https://github.com/OpenKitten/MongoKitten) :star: 720 - A pure Swift MongoDB client implementation with support for embedded databases.
...
- [ObjectBox](https://github.com/objectbox/objectbox-swift) :star: 467 - ObjectBox is a superfast, light-weight object persistence framework.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) :star: 28832 - Algorithms and data structures in Swift, with explanations!
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) :star: 7637 - The best way to manage Dates and Timezones in Swift.
...
- [Atlantis](https://github.com/ProxymanApp/atlantis) :star: 1279 - A little and powerful iOS framework for intercepting HTTP/HTTPS Traffic from your iOS app. No more messing around with proxy and certificate config. Inspect Traffic Log with Proxyman app.
...
- [DebugSwift](https://github.com/DebugSwift/DebugSwift) :star: 488 - A comprehensive toolkit designed to simplify and enhance the debugging process for iOS applications.
- [DoraemonKit](https://github.com/didi/DoraemonKit) :star: 20218 - A full-featured iOS App development assistant，30+ tools included. You deserve it.
...
- [Flex](https://github.com/Flipboard/FLEX) :star: 14098 - An in-app debugging and exploration tool for iOS.
- [GodEye](https://github.com/zixun/GodEye) :star: 3853 - Automatically display Log,Crash,Network,ANR,Leak,CPU,RAM,FPS,NetFlow,Folder and etc with one line of code based on Swift.
...
- [Netfox](https://github.com/kasketis/netfox) :star: 3675 - A lightweight, one line setup, iOS / macOS network debugging library!
...
- [Wormholy](https://github.com/pmusolino/Wormholy) :star: 2354 - iOS network debugging, like a wizard.
...
- [Swinject](https://github.com/Swinject/Swinject) :star: 6363 - Dependency injection framework for Swift.
...
- [Weaver](https://github.com/scribd/Weaver) :star: 750 - A declarative, easy-to-use and safe Dependency Injection framework for Swift.
...
- [Needle](https://github.com/uber/needle) :star: 1841 — Compile-time safe Swift dependency injection framework with real code.
...
- [Carthage](https://github.com/Carthage/Carthage) :star: 14953 - A simple, decentralized dependency manager for Cocoa.
...
- [swift-package-manager](https://github.com/apple/swift-package-manager) :star: 9757 - The Package Manager for the Swift Programming Language.
...
- [fastlane](https://github.com/fastlane/fastlane) :star: 39688 - Connect all iOS deployment tools into one streamlined workflow.
- [deliver](https://github.com/fastlane/fastlane/tree/master/deliver) :star: 39688 - Upload screenshots, metadata and your app to the App Store using a single command.
- [snapshot](https://github.com/fastlane/fastlane/tree/master/snapshot) :star: 39688 - Automate taking localized screenshots of your iOS app on every device.
...
- [PromiseKit](https://github.com/mxcl/PromiseKit) :star: 14238 - Promises for iOS and macOS.
...
- [FileKit](https://github.com/nvzqz/FileKit) :star: 2343 - Simple and expressive file management in Swift.
...
- [FileProvider](https://github.com/amosavian/FileProvider) :star: 64 - FileManager replacement for Local, iCloud and Remote (WebDAV/FTP/Dropbox/OneDrive/SMB2) files on iOS/tvOS and macOS.
- [KZFileWatchers](https://github.com/krzysztofzablocki/KZFileWatchers) :star: 1084 - A micro-framework for observing file changes, both local and remote. Helpful in building developer tools.
- [ZipArchive](https://github.com/ZipArchive/ZipArchive) :star: 5454 - ZipArchive is a simple utility class for zipping and unzipping files on iOS and Mac.
...
- [AMSMB2](https://github.com/amosavian/AMSMB2) :star: 261 - Swift framework to connect SMB 2/3 shares for iOS.
...
- [Lichess mobile](https://github.com/lichess-org/lichobile) :star: 2042 - A mobile client for lichess.org.
...
- [SwiftSVG](https://github.com/mchoe/SwiftSVG) :star: 1941 -  A single pass SVG parser with multiple interface options (String, NS/UIBezierPath, CAShapeLayer, and NS/UIView).
...
- [BluetoothKit](https://github.com/rhummelmose/BluetoothKit) :star: 2277 - Easily communicate between iOS/macOS devices using BLE.
...
- [Bluejay](https://github.com/steamclock/bluejay) :star: 1095 - A simple Swift framework for building reliable Bluetooth LE apps.
...
- [YPImagePicker](https://github.com/Yummypets/YPImagePicker) :star: 4322 - Instagram-like image picker & filters for iOS.
...
- [ExyteMediaPicker](https://github.com/exyte/mediapicker) :star: 336 - Customizable media picker
...
- [SwiftLocation](https://github.com/malcommac/SwiftLocation) :star: 3401 - Location & Beacon Monitoring in Swift.
...
- [DeviceKit](https://github.com/devicekit/DeviceKit) :star: 4470 - DeviceKit is a value-type replacement of UIDevice.
...
- [WatchShaker](https://github.com/ezefranca/WatchShaker) :star: 232 - WatchShaker is a watchOS helper to get your shake movement written in swift.
...
- [NFCPassportReader](https://github.com/AndyQ/NFCPassportReader) :star: 760 - Swift library  to read an NFC enabled passport. Supports BAC, Secure Messaging, and both active and passive authentication. Requires iOS 13 or above.
...
- [SnapKit](https://github.com/SnapKit/SnapKit) :star: 19995 - A Swift Autolayout DSL for iOS & macOS.
...
- [TinyConstraints](https://github.com/roberthein/TinyConstraints) :star: 3988 -  The syntactic sugar that makes Auto Layout sweeter for human use.
- [MyLinearLayout](https://github.com/youngsoft/MyLinearLayout) :star: 4408 - MyLayout is a powerful iOS UI framework implemented by Objective-C. It integrates the functions with Android Layout,iOS AutoLayout,SizeClass, HTML CSS float and flexbox and bootstrap.
...
- [PinLayout](https://github.com/layoutBox/PinLayout) :star: 2372 - Fast Swift Views layouting without auto layout. No magic, pure code, full control and blazing fast. Concise syntax, intuitive, readable & chainable.
...
- [FlexLayout](https://github.com/layoutBox/FlexLayout) - FlexLayout gently wraps the highly optimized [facebook/yoga](https://github.com/facebook/yoga) :star: 17328 flexbox implementation in a concise, intuitive & chainable syntax.
...
- [YogaKit](https://github.com/facebook/yoga/tree/master/YogaKit) :star: 17328 - Powerful layout engine which implements Flexbox.
...
- [Grid](https://github.com/exyte/Grid) :star: 1788 - The most powerful Grid container missed in SwiftUI.
...
- [BartyCrouch](https://github.com/Flinesoft/BartyCrouch) :star: 1366 - Incrementally update/translate your Strings files from Code and Storyboards/XIBs.
...
- [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) :star: 13215 - A fast & simple, yet powerful & flexible logging framework for Mac and iOS.
...
- [SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) :star: 5935 - Convenient logging during development and release.
...
- [XCGLogger](https://github.com/DaveWoodCom/XCGLogger) :star: 3951 - A debug log framework for use in Swift projects. Allows you to log details to the console (and optionally a file), just like you would have with NSLog or println, but with additional information, such as the date, function name, filename and line number.
...
- [Diagnostics](https://github.com/WeTransfer/Diagnostics) :star: 961 - Allow users to easily share Diagnostics with your support team to improve the flow of fixing bugs.
- [Gedatsu](https://github.com/bannzai/gedatsu) :star: 531 - Provide readable format about AutoLayout error console log.
- [Pulse](https://github.com/kean/Pulse) :star: 6368 - Pulse is a powerful logging system for Apple Platforms. Native. Built with SwiftUI.
...
- [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) :star: 186531 - The official Google-built powerful neural network library port for iOS.
...
- [CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) :star: 6488 - A collection of unique Core ML Models.
...
- [Mapbox GL](https://github.com/mapbox/mapbox-gl-native) :star: 4379 - An OpenGL renderer for Mapbox Vector Tiles with SDK bindings for iOS.
...
- [AudioKit](https://github.com/audiokit/AudioKit) :star: 10732 - A powerful toolkit for synthesizing, processing, and analyzing sounds.
- [EZAudio](https://github.com/syedhali/EZAudio) :star: 4961 - An iOS/macOS audio visualization framework built upon Core Audio useful for anyone doing real-time, low-latency audio processing and visualizations.
...
- [SwiftySound](https://github.com/adamcichy/SwiftySound) :star: 1248 - Super simple library that lets you play sounds with a single line of code (and much more). Written in Swift 3, supports iOS, macOS and tvOS. CocoaPods and Carthage compatible.
...
- [Porcupine](https://github.com/Picovoice/Porcupine) :star: 3781 - On-device wake word detection engine for macOS, iOS, and watchOS, powered by deep learning.
...
- [FLAnimatedImage](https://github.com/Flipboard/FLAnimatedImage) :star: 7939 - Performant animated GIF engine for iOS.
- [gifu](https://github.com/kaishin/gifu) :star: 3093 - Highly performant animated GIF support for iOS in Swift.
...
- [SwiftyGif](https://github.com/kirualex/SwiftyGif) :star: 2038 - High performance GIF engine.

**[back to top](#contributing-and-collaborating)**

### Image
- [GPU Image](https://github.com/BradLarson/GPUImage) :star: 20251 - An open source iOS framework for GPU-based image and video processing.
...
- [SDWebImage](https://github.com/SDWebImage/SDWebImage) :star: 25062 - Asynchronous image downloader with cache support with an UIImageView category.
...
- [TOCropViewController](https://github.com/TimOliver/TOCropViewController) :star: 4733 - A view controller that allows users to crop UIImage objects.
...
- [Nuke](https://github.com/kean/Nuke) :star: 8164 - Image loading, processing, caching and preheating.
- [FlagKit](https://github.com/madebybowtie/FlagKit) :star: 3042 - Beautiful flag icons for usage in apps and on the web.
...
- [Kingfisher](https://github.com/onevcat/Kingfisher) :star: 23417 - A lightweight and pure Swift implemented library for downloading and caching image from the web.
...
- [Agrume](https://github.com/JanGorman/Agrume) :star: 813 - A lemony fresh iOS image viewer written in Swift.
...
- [Lightbox](https://github.com/hyperoslo/Lightbox) :star: 1651 - A convenient and easy to use image viewer for your iOS app.
...
- [MetalPetal](https://github.com/MetalPetal/MetalPetal) :star: 1931 - A GPU-accelerated image/video processing framework based on [Metal](https://developer.apple.com/metal/).
...
- [GPUImage3](https://github.com/BradLarson/GPUImage3) :star: 2747 - GPUImage 3 is a BSD-licensed Swift framework for GPU-accelerated video and image processing using Metal.
- [Harbeth](https://github.com/yangKJ/Harbeth) :star: 515 - Metal API for GPU accelerated Graphics and Video and Camera filter framework.🔥💥
...
- [Pixel](https://github.com/muukii/Pixel) :star: 3354 - An image editor and engine using CoreImage.
...
- [SFSafeSymbols](https://github.com/piknotech/SFSafeSymbols) :star: 1718 - Safely access Apple's SF Symbols using static typing.
...
- [NSFWDetector](https://github.com/lovoo/NSFWDetector) :star: 1588 - A NSFW (aka porn) detector with CoreML.
...
- [TPPDF](https://github.com/Techprimate/TPPDF) :star: 746 - Generate PDF using commands and automatic layout.
...
### Streaming
- [HaishinKit.swift](https://github.com/shogo4405/HaishinKit.swift) :star: 2783 - Camera and Microphone streaming library via RTMP, HLS for iOS, macOS.
- [StreamingKit](https://github.com/tumtumtum/StreamingKit) :star: 2428 - A fast and extensible gapless AudioPlayer/AudioStreamer for macOS and iOS.
...
- [ZFPlayer](https://github.com/renzifeng/ZFPlayer) :star: 7075 - Based on AVPlayer, support for the horizontal screen, vertical screen (full screen playback can also lock the screen direction), the upper and lower slide to adjust the volume, the screen brightness, or so slide to adjust the playback progress.
...
- [PryntTrimmerView](https://github.com/HHK1/PryntTrimmerView) :star: 862 - A set of UI elements to trim, crop and select frames inside a video.
...
- [MessageKit](https://github.com/MessageKit/MessageKit) :star: 6040 - Eventually, a Swift re-write of JSQMessagesViewController.
...
- [ChatLayout](https://github.com/ekazaev/ChatLayout) :star: 896 - A lightweight framework to build chat UI that uses custom `UICollectionViewLayout` to provide full control over the presentation as well as all the tools available in `UICollectionView`.
- [ExyteChat](https://github.com/exyte/Chat) :star: 951 - SwiftUI Chat UI framework with fully customizable message cells, input view, and a built-in media picker.
...
- [Alamofire](https://github.com/Alamofire/Alamofire) :star: 41178 - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
...
- [Reachability.swift](https://github.com/ashleymills/Reachability.swift) :star: 7956 - Replacement for Apple's Reachability re-written in Swift with closures.
- ~~[OctopusKit](https://github.com/icoco/OctopusKit) - A simplicity but graceful solution for invoke RESTful web service APIs.~~
- [Moya](https://github.com/Moya/Moya) :star: 15153 - Network abstraction layer written in Swift.
...
- [Get](https://github.com/kean/Get) :star: 945 - A modern Swift web API client built using async/await.
...
- [PEM](https://github.com/fastlane/fastlane/tree/master/pem) :star: 39688 - Automatically generate and renew your push notification profiles.
...
- [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) :star: 32116 list.
- [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) :star: 42842 list of open source iOS apps.

- [awsome-ios-animation](https://github.com/ameizi/awesome-ios-animation) :star: 5240 - A curated list of awesome iOS animation, including Objective-C and Swift libraries.
- [awesome-gists](https://github.com/vsouza/awesome-gists#ios) :star: 671 - A list of amazing gists (iOS section).
- [awesome-interview-questions](https://github.com/MaximAbramchuck/awesome-interview-questions#ios) :star: 71633 - A curated awesome list of lists of interview questions including iOS.
- [iOS-Playbook](https://github.com/bakkenbaeck/iOS-handbook) :star: 385 - Guidelines and best practices for excellent iOS apps.
- [iOS-Learning-Materials](https://github.com/jVirus/iOS-Learning-Materials) :star: 2851 - Curated list of articles, web-resources, tutorials and code repositories that may help you dig a little bit deeper into iOS.
...
- [Marketing for Engineers](https://github.com/LisaDziuba/Marketing-for-Engineers) :star: 12782 - A curated collection of marketing articles & tools to grow your product.
- [Awesome ARKit](https://github.com/olucurious/Awesome-ARKit) :star: 7868 - A curated list of awesome ARKit projects and resources.
- [CocoaConferences](https://github.com/Lascorbe/CocoaConferences) :star: 1110 - List of cocoa conferences for iOS & macOS developers.
- [example-ios-apps](https://github.com/jogendra/example-ios-apps) :star: 1140 - A curated list of Open Source example iOS apps developed in Swift.
...
- [Awesome list of open source applications for macOS](https://github.com/serhii-londar/open-source-mac-os-apps) :star: 41844 - List of awesome open source applications for macOS.
- [Awesome iOS Interview question list](https://github.com/dashvlas/awesome-ios-interview) :star: 1164 - Guide for interviewers and interviewees. Review these iOS interview questions - and get some practical tips along the way.
...
- [awesome-ios-books](https://github.com/bystritskiy/awesome-ios-books) :star: 455 - A list of books for iOS developers.
...
- [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) :star: 22682 - The better way to deal with JSON data in Swift.
...
- [Kanna](https://github.com/tid-kijyun/Kanna) :star: 2420  - Kanna(鉋) is an XML/HTML parser for macOS/iOS.
...
- [SWXMLHash](https://github.com/drmohundro/SWXMLHash) :star: 1410 - Simple XML parsing in Swift.
- [SwiftyXML](https://github.com/chenyunguiMilook/SwiftyXML) :star: 103 - The most swifty way to deal with XML data in swift 4.
- [XMLCoder](https://github.com/MaxDesiatov/XMLCoder) :star: 803 - Encoder & Decoder for XML using Swift's `Codable` protocols.
- [ZMarkupParser](https://github.com/ZhgChgLi/ZMarkupParser) :star: 317 - Convert HTML strings into NSAttributedString with customized styles and tags.
...
- [CoreXLSX](https://github.com/MaxDesiatov/CoreXLSX) :star: 834 - Excel spreadsheet (XLSX) format support in pure Swift.
- [SVGView](https://github.com/exyte/SVGView) :star: 661 - SVG parser and renderer written in SwiftUI.
- [CreateAPI](https://github.com/CreateAPI/CreateAPI) :star: 416 - Delightful code generation for OpenAPI specs for Swift written in Swift.
- [NetNewsWire](https://github.com/Ranchero-Software/NetNewsWire) :star: 8435 - It’s a free and open-source feed reader for macOS and iOS.
...
- [SwiftyStoreKit](https://github.com/bizz84/SwiftyStoreKit) :star: 6573 - Lightweight In App Purchases Swift framework for iOS 8.0+ and macOS 9.0+
...
- [Tuist](https://github.com/tuist/tuist) :star: 4639 - A tool to create, maintain and interact with Xcode projects at scale.
...
- [RxSwift](https://github.com/ReactiveX/RxSwift) :star: 24399 - Reactive Programming in Swift.
...
- [ReSwift](https://github.com/ReSwift/ReSwift) :star: 7553 - Unidirectional Data Flow in Swift - Inspired by Redux.
...
- [ReactiveSwift](https://github.com/ReactiveCocoa/ReactiveSwift) :star: 3006 - Streams of values over time by ReactiveCocoa group.
...
- [OpenCombine](https://github.com/broadwaylamb/OpenCombine) :star: 2727 — Open source implementation of Apple's Combine framework for processing values over time.
- [OneWay](https://github.com/DevYeom/OneWay) :star: 87 - A Swift library for state management with unidirectional data flow.
- [Verge](https://github.com/muukii/Verge) :star: 650 - Verge is a faster and scalable state management library for UIKit and SwiftUI
...
- [Tokamak](https://github.com/MaxDesiatov/Tokamak) :star: 2622 - React-like framework providing a declarative API for building native UI components with easy to use one-way data binding.
...
- [Runtime](https://github.com/wickwirew/Runtime) :star: 1091 - A Swift Runtime library for viewing type info, and the dynamic getting and setting of properties.
...
- [Venmo](#payments)
- [AWS](https://github.com/aws-amplify/aws-sdk-ios) :star: 1681 Amazon Web Services Mobile SDK for iOS.
...
- [ResearchKit](https://github.com/ResearchKit/ResearchKit) :star: 5614 ResearchKit is an open source software framework that makes it easy to create apps for medical research or for other research projects.
...
- [twitter-kit-ios](https://github.com/twitter-archive/twitter-kit-ios) :star: 691 - Twitter Kit is a native SDK to include Twitter content inside mobile apps.
...
- [Adapty](https://github.com/adaptyteam/AdaptySDK-iOS) :star: 376 - Integrate in-app subscriptions and a/b testing for them with 3 lines of code.
