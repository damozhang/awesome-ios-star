...
- [Crossroad](https://github.com/giginet/Crossroad) [★ 332] - Crossroad is an URL router focused on handling Custom URL Schemes. Using this, you can route multiple URL schemes and fetch arguments and parameters easily.
...
- [Cache](https://github.com/hyperoslo/Cache) [★ 2344] - Nothing but Cache.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [★ 33472].
...
- [Swiftlint](https://github.com/realm/SwiftLint) [★ 14831] - A tool to enforce Swift style and conventions.
...
- [CoreStore](https://github.com/JohnEstropia/CoreStore) [★ 2909] - Powerful Core Data framework for Incremental Migrations, Fetching, Observering, etc.
...
- [SQLite.swift](https://github.com/stephencelis/SQLite.swift) [★ 7611] - A type-safe, Swift-language layer over SQLite3.
...
- [MMKV](https://github.com/Tencent/MMKV) [★ 12770] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [★ 24970] - Algorithms and data structures in Swift, with explanations!
...
- [PromiseKit](https://github.com/mxcl/PromiseKit) [★ 13427] - Promises for iOS and macOS.
...
- [ZipArchive](https://github.com/ZipArchive/ZipArchive) [★ 4793] - ZipArchive is a simple utility class for zipping and unzipping files on iOS and Mac.
...
- [ZIPFoundation](https://github.com/weichsel/ZIPFoundation) [★ 1610] - Effortless ZIP Handling in Swift.
...
- [SVGKit](https://github.com/SVGKit/SVGKit) [★ 4036] - Display and interact with SVG Images on iOS / macOS, using native rendering (CoreAnimation) (currently only supported for iOS - macOS code needs updating).
...
- [Macaw](https://github.com/exyte/macaw) [★ 5629] - Powerful and easy-to-use vector graphics library with SVG support written in Swift.
...
- [YPImagePicker](https://github.com/Yummypets/YPImagePicker) [★ 3462] - Instagram-like image picker & filters for iOS.
...
- [DeviceKit](https://github.com/devicekit/DeviceKit) [★ 3355] - DeviceKit is a value-type replacement of UIDevice.
...
- [SnapKit](https://github.com/SnapKit/SnapKit) [★ 17595] - A Swift Autolayout DSL for iOS & macOS.
- [Cartography](https://github.com/robb/Cartography) [★ 7241] - A declarative Auto Layout DSL for Swift.
...
- [FlexLayout](https://github.com/layoutBox/FlexLayout) - FlexLayout gently wraps the highly optimized [facebook/yoga](https://github.com/facebook/yoga) [★ 14393] flexbox implementation in a concise, intuitive & chainable syntax.
...
- [YogaKit](https://github.com/facebook/yoga/tree/master/YogaKit) [★ 14393] - Powerful layout engine which implements Flexbox.
...
- [SwiftyBeaver](https://github.com/SwiftyBeaver/SwiftyBeaver) [★ 5215] - Convenient logging during development and release.
- [SwiftyTextTable](https://github.com/scottrhoyt/SwiftyTextTable) [★ 260] - A lightweight tool for generating text tables.
- [Watchdog](https://github.com/wojteklu/Watchdog) [★ 1778] - Class for logging excessive blocking on the main thread.
- [XCGLogger](https://github.com/DaveWoodCom/XCGLogger) [★ 3651] - A debug log framework for use in Swift projects. Allows you to log details to the console (and optionally a file), just like you would have with NSLog or println, but with additional information, such as the date, function name, filename and line number.
...
- [SwiftTrace](https://github.com/johnno1962/SwiftTrace) [★ 462] - Trace Swift and Objective-C method invocations.
...
- [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) [★ 156592] - The official Google-built powerful neural network library port for iOS.
...
- [CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) [★ 5042] - A collection of unique Core ML Models.
...
- [AudioKit](https://github.com/audiokit/AudioKit) [★ 8472] - A powerful toolkit for synthesizing, processing, and analyzing sounds.
...
- [Nuke](https://github.com/kean/Nuke) [★ 6118] - Image loading, processing, caching and preheating.
- [FlagKit](https://github.com/madebybowtie/FlagKit) [★ 2739] - Beautiful flag icons for usage in apps and on the web.
...
- [Kingfisher](https://github.com/onevcat/Kingfisher) [★ 18512] - A lightweight and pure Swift implemented library for downloading and caching image from the web.
...
### Streaming
- [HaishinKit.swift](https://github.com/shogo4405/HaishinKit.swift) [★ 2109] - Camera and Microphone streaming library via RTMP, HLS for iOS, macOS.
...
- [MessageKit](https://github.com/MessageKit/MessageKit) [★ 4796] - Eventually, a Swift re-write of JSQMessagesViewController.
...
- [Alamofire](https://github.com/Alamofire/Alamofire) [★ 35830] - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
...
- [ResponseDetective](https://github.com/netguru/ResponseDetective) [★ 1900] - Sherlock Holmes of the networking layer.
...
- [Mail Core 2](https://github.com/MailCore/mailcore2) [★ 2300] - MailCore 2 provide a simple and asynchronous API to work with e-mail protocols IMAP, POP and SMTP.
...
- [PEM](https://github.com/fastlane/fastlane/tree/master/pem) [★ 32434] - Automatically generate and renew your push notification profiles.
...
- [SPPermissions](https://github.com/ivanvorobei/SPPermissions) [★ 4388] - Ask permissions on Swift. Available List, Dialog & Native interface. Can check state permission.

## Reactive Programming
- [RxSwift](https://github.com/ReactiveX/RxSwift) [★ 20226] - Reactive Programming in Swift.
...
- [ReactiveSwift](https://github.com/ReactiveCocoa/ReactiveSwift) [★ 2764] - Streams of values over time by ReactiveCocoa group.
...
- [OpenCombine](https://github.com/broadwaylamb/OpenCombine) [★ 1831] — Open source implementation of Apple's Combine framework for processing values over time.
...
- [1Password](https://github.com/AgileBits/onepassword-app-extension) [★ 2564] - 1Password Extension for iOS Apps.
- [CareKit](https://github.com/carekit-apple/CareKit) [★ 2078] - CareKit is an open source software framework for creating apps that help people better understand and manage their health. By Apple.
...
- [CryptoSwift](https://github.com/krzyzanowskim/CryptoSwift) [★ 8527] - Crypto related functions and helpers for Swift implemented in Swift programming language.
...
- [RNCryptor](https://github.com/RNCryptor/RNCryptor) [★ 3259] - CCCryptor (AES encryption) wrappers for iOS and Mac in Swift. -- For ObjC, see RNCryptor/RNCryptor-objc.
