...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4754] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9153] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [:star: 14168] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6829] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17565] - A tool to enforce Swift style and conventions.
...
- [SwiftyUserDefaults](https://github.com/sunshinejr/SwiftyUserDefaults) [:star: 4765] - Statically-typed NSUserDefaults.
- [SugarRecord](https://github.com/modo-studio/SugarRecord) [:star: 2126]  - Data persistence management library.
- [SQLite.swift](https://github.com/stephencelis/SQLite.swift) [:star: 9043] - A type-safe, Swift-language layer over SQLite3.
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6027] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16014] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 27915] - Algorithms and data structures in Swift, with explanations!
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) [:star: 7378] - The best way to manage Dates and Timezones in Swift.
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 13624] - An in-app debugging and exploration tool for iOS.
...
- [Wormholy](https://github.com/pmusolino/Wormholy) [:star: 2216] - iOS network debugging, like a wizard.
...
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 19571] - A full-featured iOS App development assistant，30+ tools included. You deserve it.
