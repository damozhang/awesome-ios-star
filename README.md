...
- [ios-architecture](https://github.com/tailec/ios-architecture) [:star: 1247] - A collection of iOS architectures - MVC, MVVM, MVVM+RxSwift, VIPER, RIBs and many others.
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 3753] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [Disk](https://github.com/saoudrizwan/Disk) [:star: 2975] - Delightful framework for iOS to easily persist structs, images, and data.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 35613].
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 16546] - A tool to enforce Swift style and conventions.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 5370] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [IceCream](https://github.com/caiyue1993/IceCream) [:star: 1781] - Sync Realm Database with CloudKit.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 15025] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
- [Defaults](https://github.com/sindresorhus/Defaults) [:star: 1204] - Swifty and modern UserDefaults.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 26908] - Algorithms and data structures in Swift, with explanations!
