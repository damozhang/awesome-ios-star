...
- [FSLineChart](https://github.com/ArthurGuibert/FSLineChart) :star: 842 - A line chart library for iOS.
- [JBChartView](https://github.com/Jawbone/JBChartView) :star: 3693 - iOS-based charting library for both line and bar graphs.
...
- [Bootstrap](https://github.com/krzysztofzablocki/Bootstrap) :star: 2034 - iOS project bootstrap aimed at high quality coding.
...
- [AsyncQueue](https://github.com/dfed/swift-async-queue) :star: 288 - A library of queues that enable sending ordered tasks from synchronous to asynchronous contexts.
...
- [iso-8601-date-formatter](https://github.com/boredzo/iso-8601-date-formatter) :star: 593 - A Cocoa NSFormatter subclass to convert dates to and from ISO-8601-formatted strings. Supports calendar, week, and ordinal formats.
- [Kronos](https://github.com/lyft/Kronos) :star: 700 - Elegant NTP date library in Swift.
...
- [jot](https://github.com/IFTTT/jot) :star: 1766 - An iOS framework for easily adding drawings and text to images.
...
- [Masonry](https://github.com/SnapKit/Masonry) :star: 18124 - Harness the power of AutoLayout NSLayoutConstraints with a simplified, chainable and expressive syntax.
...
- [MyLinearLayout](https://github.com/youngsoft/MyLinearLayout) :star: 4401 - MyLayout is a powerful iOS UI framework implemented by Objective-C. It integrates the functions with Android Layout,iOS AutoLayout,SizeClass, HTML CSS float and flexbox and bootstrap.
...
- [Hodor](https://github.com/Aufree/Hodor) :star: 538 - Simple solution to localize your iOS App.
- [IBLocalizable](https://github.com/PiXeL16/IBLocalizable) :star: 453 - Localize your views directly in Interface Builder with IBLocalizable.
...
- [LocalizationKit](https://github.com/willpowell8/LocalizationKit_iOS) :star: 1208 - Localization management in realtime from a web portal. Easily manage your texts and translations without redeploy and resubmission.
...
- [SwiftOCR](https://github.com/garnele007/SwiftOCR) :star: 4628 - Fast and simple OCR library written in Swift.
...
- [WKZombie](https://github.com/mkoehnke/WKZombie) :star: 1186 - WKZombie is a Swift framework for iOS/macOS to navigate within websites and collect data without the need of User Interface or API, also known as Headless browser. It can be used to run automated tests or manipulate websites using Javascript.
...
- [merchantkit](https://github.com/benjaminmayo/merchantkit) :star: 1111 - A modern In-App Purchases management framework for iOS.
...
- [JSONNeverDie](https://github.com/johnlui/JSONNeverDie) :star: 443 - Auto reflection tool from JSON to Model, user friendly JSON encoder / decoder, aims to never die.
...
- [Swifter](https://github.com/mattdonnelly/Swifter) :star: 2347 - :bird: A Twitter framework for iOS & macOS written in Swift.
...
- [swift-sodium](https://github.com/jedisct1/swift-sodium) :star: 554 - Safe and easy to use crypto for iOS.
...
- [SwiftyAttributes](https://github.com/eddiekaiger/SwiftyAttributes) :star: 1626 - Swift extensions that make it a breeze to work with attributed strings.
...
- [fireworks](https://github.com/tomkowz/fireworks) :star: 343 - Fireworks effect for UIView
- [FlightAnimator](https://github.com/AntonTheDev/FlightAnimator) :star: 576 - Advanced Natural Motion Animations, Simple Blocks Based Syntax.
- [FlightAnimator](https://github.com/AntonTheDev/FlightAnimator) :star: 576 - Advanced Natural Motion Animations, Simple Blocks Based Syntax.
...
- [AnimatedTransitionGallery](https://github.com/shu223/AnimatedTransitionGallery) :star: 2501 - Collection of iOS 7 custom animated transitions using UIViewControllerAnimatedTransitioning protocol.
...
- [View2ViewTransition](https://github.com/naru-jpn/View2ViewTransition) :star: 846 - Custom interactive view controller transition from one view to another view.
- [ZFDragableModalTransition](https://github.com/zoonooz/ZFDragableModalTransition) :star: 2442 - Custom animation transition for present modal view controller.
...
- [BulletinBoard](https://github.com/alexaubry/BulletinBoard) :star: 5334 - Generate and Display Bottom Card Interfaces on iOS
...
- [BadgeHub](https://github.com/jogendra/BadgeHub) :star: 799 - Make any UIView a full fledged animated notification center. It is a way to quickly add a notification badge icon to a UIView.
...
- [Context-Menu.iOS](https://github.com/Yalantis/Context-Menu.iOS) :star: 1822 - You can easily add awesome animated context menu to your app.
- [ContextMenu](https://github.com/GitHawkApp/ContextMenu) :star: 968 - An iOS context menu UI inspired by Things 3.
- [DropDown](https://github.com/AssistoLab/DropDown) :star: 2553 - A Material Design drop down for iOS
...
- [ENSwiftSideMenu](https://github.com/evnaz/ENSwiftSideMenu) :star: 1799 - A simple side menu for iOS 7/8 written in Swift.
...
- [SVPullToRefresh](https://github.com/samvermette/SVPullToRefresh) :star: 4774 - Give pull-to-refresh & infinite scrolling to any UIScrollView with 1 line of code. http://samvermette.com/314
...
- [AppStoreStyleHorizontalScrollView](https://github.com/terenceLuffy/AppStoreStyleHorizontalScrollView) :star: 652 - App store style horizontal scroll view.
...
- [VegaScroll](https://github.com/AppliKeySolutions/VegaScroll) :star: 2900 - VegaScroll is a lightweight animation flowlayout for UICollectionView completely written in Swift 4, compatible with iOS 11 and Xcode 9
...
- [ASValueTrackingSlider](https://github.com/alskipp/ASValueTrackingSlider) :star: 1819 - A UISlider subclass that displays the slider value in a popup view
...
- [KYWheelTabController](https://github.com/ykyouhei/KYWheelTabController) :star: 118 - KYWheelTabController is a subclass of UITabBarController.It displays the circular menu instead of UITabBar.
...
- [VTMagic](https://github.com/tianzhuo112/VTMagic) :star: 1800 - VTMagic is a page container library for iOS.
- [ZYThumbnailTableView](https://github.com/liuzhiyi1992/ZYThumbnailTableView) :star: 928 - a TableView have thumbnail cell only, and you can use gesture let it expands other expansionView, all diy
...
- [AMTagListView](https://github.com/andreamazz/AMTagListView) :star: 755 - UIScrollView subclass that allows to add a list of highly customizable tags.
...
- [SelectableTextView](https://github.com/jhurray/SelectableTextView) :star: 620 - A text view that supports selection and expansion.
...
- [Onboard](https://github.com/mamaral/Onboard) :star: 6557 - Easily create a beautiful and engaging onboarding experience with only a few lines of code.
...
- [Conferences.digital](https://github.com/zagahr/Conferences.digital) :star: 758 - Watch conference videos in a native macOS app.
...
* [XcodeEquatableGenerator](https://github.com/sergdort/XcodeEquatableGenerator) :star: 187 - Xcode 8 Source Code Extension will generate conformance to Swift Equatable protocol based on type and fields selection.
