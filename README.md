...
- [JLRoutes](https://github.com/joeldev/JLRoutes) [:star: 5499] - URL routing library for iOS with a simple block-based API.
...
- [Composable Navigator](https://github.com/Bahn-X/swift-composable-navigator) [:star: 441] - An open source library for building deep-linkable SwiftUI applications with composition, testing and ergonomics in mind
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 2656] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [ARVideoKit](https://github.com/AFathi/ARVideoKit) [:star: 1380] - Record and capture ARKit videos, photos, Live Photos, and GIFs.
...
- [OAuthSwift](https://github.com/OAuthSwift/OAuthSwift) [:star: 2922] - Swift based OAuth library for iOS
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [:star: 13809] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 33995].
...
- [FBRetainCycleDetector](https://github.com/facebook/FBRetainCycleDetector) [:star: 3958] - iOS library to help detecting retain cycles in runtime.
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 5087] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Hue](https://github.com/zenangst/Hue) [:star: 3283] - Hue is the all-in-one coloring utility that you'll ever need.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 4464] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [WCDB](https://github.com/Tencent/wcdb) [:star: 9159] - WCDB is an efficient, complete, easy-to-use mobile database framework for iOS, macOS.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 13487] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [DateHelper](https://github.com/melvitax/DateHelper) [:star: 1275] - Convenience extension for NSDate in Swift.
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 12561] - An in-app debugging and exploration tool for iOS.
...
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 17985] - A full-featured iOS App development assistant，30+ tools included. You deserve it. 
...
- [PromiseKit](https://github.com/mxcl/PromiseKit) [:star: 13596] - Promises for iOS and macOS.
...
- [promises](https://github.com/google/promises) [:star: 3540] - Google provides a synchronization construct for Objective-C and Swift to facilitate writing asynchronous code.
...
- [ZipArchive](https://github.com/ZipArchive/ZipArchive) [:star: 4888] - ZipArchive is a simple utility class for zipping and unzipping files on iOS and Mac.
...
- [SwiftLocation](https://github.com/malcommac/SwiftLocation) [:star: 2991] - Location & Beacon Monitoring in Swift.
...
- [SnapKit](https://github.com/SnapKit/SnapKit) [:star: 17863] - A Swift Autolayout DSL for iOS & macOS.
...
- [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) [:star: 12509] - A fast & simple, yet powerful & flexible logging framework for Mac and iOS.
...
- [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) [:star: 159319] - The official Google-built powerful neural network library port for iOS.
...
- [CoreML-Models](https://github.com/likedan/Awesome-CoreML-Models) [:star: 5128] - A collection of unique Core ML Models.
...
- [AudioKit](https://github.com/audiokit/AudioKit) [:star: 8689] - A powerful toolkit for synthesizing, processing, and analyzing sounds.
...
- [SDWebImage](https://github.com/SDWebImage/SDWebImage) [:star: 23781] - Asynchronous image downloader with cache support with an UIImageView category.
...
- [Nuke](https://github.com/kean/Nuke) [:star: 6317] - Image loading, processing, caching and preheating.
...
- [Kingfisher](https://github.com/onevcat/Kingfisher) [:star: 19054] - A lightweight and pure Swift implemented library for downloading and caching image from the web.
...
- [MetalPetal](https://github.com/MetalPetal/MetalPetal) [:star: 1102] - A GPU-accelerated image/video processing framework based on [Metal](https://developer.apple.com/metal/).
...
- [Pixel](https://github.com/muukii/Pixel) [:star: 2421] - An image editor and engine using CoreImage.
...
- [LFLiveKit](https://github.com/LaiFengiOS/LFLiveKit) [:star: 4234] - H264 and AAC Hard coding，support GPUImage Beauty， rtmp transmission，weak network lost frame，Dynamic switching rate.
...
- [MessageKit](https://github.com/MessageKit/MessageKit) [:star: 4913] - Eventually, a Swift re-write of JSQMessagesViewController.
...
- [Alamofire](https://github.com/Alamofire/Alamofire) [:star: 36424] - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
...
- [Moya](https://github.com/Moya/Moya) [:star: 13369] - Network abstraction layer written in Swift.
...
- [swift-protobuf](https://github.com/apple/swift-protobuf) [:star: 3631] - Plugin and runtime library for using protobuf with Swift.
...
- [PEM](https://github.com/fastlane/fastlane/tree/master/pem) [:star: 32944] - Automatically generate and renew your push notification profiles.
...
- [NWPusher](https://github.com/noodlewerk/NWPusher) [:star: 6102] - macOS and iOS application and framework to play with the Apple Push Notification service (APNs).
...
- [SwiftyJSON](https://github.com/SwiftyJSON/SwiftyJSON) [:star: 20865] - The better way to deal with JSON data in Swift.
