...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4801] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
- [CleanArchitectureRxSwift](https://github.com/sergdort/CleanArchitectureRxSwift) [:star: 3723] - Example of Clean Architecture of iOS app using RxSwift.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9338] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [OAuthSwift](https://github.com/OAuthSwift/OAuthSwift) [:star: 3155] - Swift based OAuth library for iOS- [OAuthSwift](https://github.com/OAuthSwift/OAuthSwift) [:star: 3155] - Swift based OAuth library for iOS
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6877] - A code library and command-line formatting tool for reformatting Swift code.
...
- [DynamicColor](https://github.com/yannickl/DynamicColor) [:star: 2879] - Yet another extension to manipulate colors easily in Swift.
...
- [CoreStore](https://github.com/JohnEstropia/CoreStore) [:star: 3809] - Powerful Core Data framework for Incremental Migrations, Fetching, Observering, etc.
...
- [Realm](https://github.com/realm/realm-cocoa) [:star: 15966] - The alternative to CoreData and SQLite: Simple, modern and fast.
...
- [SQLite.swift](https://github.com/stephencelis/SQLite.swift) [:star: 9072] - A type-safe, Swift-language layer over SQLite3.
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6087] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) [:star: 3043] - A collaborative list of Parse alternative backend service providers.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16069] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
- [Defaults](https://github.com/sindresorhus/Defaults) [:star: 1558] - Swifty and modern UserDefaults.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 27963] - Algorithms and data structures in Swift, with explanations!
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 13647] - An in-app debugging and exploration tool for iOS.
- [chisel](https://github.com/facebook/chisel) [:star: 9012] - Collection of LLDB commands to assist debugging iOS apps.
...
- [MTHawkeye](https://github.com/meitu/MTHawkeye) [:star: 1440] - Profiling / Debugging assist tools for iOS, include tools: UITimeProfiler, Memory Allocations, Living ObjC Objects Sniffer, Network Transaction Waterfall, etc.
