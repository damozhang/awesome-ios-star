...
* [DeepLinkKit](https://github.com/button/DeepLinkKit) [★ 3217] - A splendid route-matching, block-based way to handle your deep links.
* [IntentKit](https://github.com/intentkit/IntentKit) [★ 1821] - An easier way to handle third-party URL schemes in iOS apps.
* [JLRoutes](https://github.com/joeldev/JLRoutes) [★ 4959] - URL routing library for iOS with a simple block-based API.
...
* [URLNavigator](https://github.com/devxoul/URLNavigator) [★ 1946] - ⛵️ Elegant URL Routing for Swift
...
* [ApplicationCoordinator](https://github.com/AndreyPanov/ApplicationCoordinator) [★ 473] - Coordinator is an object that handles navigation flow and shares flow’s handling for the next coordinator after switching on the next chain.
...
* [XCDYouTubeKit](https://github.com/0xced/XCDYouTubeKit) [★ 2499] - YouTube video player for iOS, tvOS and macOS
...
* [CleanArchitectureRxSwift](https://github.com/sergdort/CleanArchitectureRxSwift) [★ 2070] - Example of Clean Architecture of iOS app using RxSwift.
...
* [ios-architecture](https://github.com/tailec/ios-architecture) [★ 365] - A collection of iOS architectures - MVC, MVVM, MVVM+RxSwift, VIPER, RIBs and many others

## ARKit

*Library and tools to help you build unparalleled augmented reality experiences*

* [ARKit-CoreLocation](https://github.com/ProjectDent/ARKit-CoreLocation) [★ 4383] -Combines the high accuracy of AR with the scale of GPS data.
* [Virtual Objects](https://github.com/ignacio-chiazzo/ARKit) [★ 225] - Placing Virtual Objects in Augmented Reality.
* [ARVideoKit](https://github.com/AFathi/ARVideoKit) [★ 921] - Record and capture ARKit videos 📹, photos 🌄, Live Photos 🎇, and GIFs 🎆.
...
* [Heimdallr.swift](https://github.com/trivago/Heimdallr.swift) [★ 536] - Easy to use OAuth 2 library for iOS, written in Swift.
