...
- [ios-architecture](https://github.com/tailec/ios-architecture) [:star: 1388] - A collection of iOS architectures - MVC, MVVM, MVVM+RxSwift, VIPER, RIBs and many others.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9332] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6876] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17616] - A tool to enforce Swift style and conventions.
...
- [SwiftyUserDefaults](https://github.com/sunshinejr/SwiftyUserDefaults) [:star: 4770] - Statically-typed NSUserDefaults.
...
- [ParseAlternatives](https://github.com/relatedcode/ParseAlternatives) [:star: 3041] - A collaborative list of Parse alternative backend service providers.
...
- [WCDB](https://github.com/Tencent/wcdb) [:star: 9759] - WCDB is an efficient, complete, easy-to-use mobile database framework for iOS, macOS.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16068] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 27962] - Algorithms and data structures in Swift, with explanations!
...
- [SwiftDate](https://github.com/malcommac/SwiftDate) [:star: 7391] - The best way to manage Dates and Timezones in Swift.
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 13646] - An in-app debugging and exploration tool for iOS.
