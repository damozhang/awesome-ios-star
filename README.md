...
- [JLRoutes](https://github.com/joeldev/JLRoutes) [:star: 5671] - URL routing library for iOS with a simple block-based API.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4881] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9578] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 36800].
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6969] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17729] - A tool to enforce Swift style and conventions.
...
- [CoreStore](https://github.com/JohnEstropia/CoreStore) [:star: 3850] - Powerful Core Data framework for Incremental Migrations, Fetching, Observering, etc.
...
- [GRDB.swift](https://github.com/groue/GRDB.swift) [:star: 6154] - A versatile SQLite toolkit for Swift, with WAL mode support.
...
- [WCDB](https://github.com/Tencent/wcdb) [:star: 9782] - WCDB is an efficient, complete, easy-to-use mobile database framework for iOS, macOS.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16155] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [ObjectBox](https://github.com/objectbox/objectbox-swift) [:star: 401] - ObjectBox is a superfast, light-weight object persistence framework.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 28025] - Algorithms and data structures in Swift, with explanations!
...
- [Kronos](https://github.com/lyft/Kronos) [:star: 608] - Elegant NTP date library in Swift.
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 13691] - An in-app debugging and exploration tool for iOS.
...
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 19652] - A full-featured iOS App development assistant，30+ tools included. You deserve it.
