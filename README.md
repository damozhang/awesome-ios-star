...
- [URLNavigator](https://github.com/devxoul/URLNavigator) [★ 2521] - Elegant URL Routing for Swift
...
- [RouteComposer](https://github.com/ekazaev/route-composer) [★ 308] - Library that helps to handle view controllers composition, routing and deeplinking tasks.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [★ 1626] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [ARKit-CoreLocation](https://github.com/ProjectDent/ARKit-CoreLocation) [★ 4859] - Combines the high accuracy of AR with the scale of GPS data.
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [★ 13470] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [HanekeSwift](https://github.com/Haneke/HanekeSwift) [★ 5067] - A lightweight generic cache for iOS written in Swift with extra love for images.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [★ 32321].
...
- [FBRetainCycleDetector](https://github.com/facebook/FBRetainCycleDetector) [★ 3813] - iOS library to help detecting retain cycles in runtime.
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [★ 4316] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [★ 14154] - A tool to enforce Swift style and conventions.
