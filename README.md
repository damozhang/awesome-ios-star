...
- [RxFlow](https://github.com/RxSwiftCommunity/RxFlow) [:star: 1823] - Navigation framework for iOS applications based on a Reactive Flow Coordinator pattern.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 10320] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 37001].
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 7182] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17957] - A tool to enforce Swift style and conventions.
...
- [DifferenceKit](https://github.com/ra1028/DifferenceKit) [:star: 3418] - A fast and flexible O(n) difference algorithm framework for Swift collection.
...
- [Playbook](https://github.com/playbook-ui/playbook-ios) [:star: 1091] - A library for isolated developing UI components and automatically snapshots of them.
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 19768] - A full-featured iOS App development assistant，30+ tools included. You deserve it.
...
- [DeviceKit](https://github.com/devicekit/DeviceKit) [:star: 4232] - DeviceKit is a value-type replacement of UIDevice.
