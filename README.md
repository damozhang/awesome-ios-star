...
- [RxFlow](https://github.com/RxSwiftCommunity/RxFlow) [:star: 1785] - Navigation framework for iOS applications based on a Reactive Flow Coordinator pattern.
...
- [XCDYouTubeKit](https://github.com/0xced/XCDYouTubeKit) [:star: 2900] - YouTube video player for iOS, tvOS and macOS.
...
- [Clean Architecture for SwiftUI + Combine](https://github.com/nalexn/clean-architecture-swiftui) [:star: 4860] - A demo project showcasing the production setup of the SwiftUI app with Clean Architecture.
...
- [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) [:star: 9490] - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
- [WebViewJavascriptBridge](https://github.com/marcuswestin/WebViewJavascriptBridge) [:star: 14181] - An iOS/macOS bridge for sending messages between Obj-C and JavaScript in UIWebViews/WebViews.
...
- [Charts](https://github.com/danielgindi/Charts) - A powerful chart / graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) [:star: 36763].
...
- [SwiftFormat](https://github.com/nicklockwood/SwiftFormat) [:star: 6941] - A code library and command-line formatting tool for reformatting Swift code.
...
- [Swiftlint](https://github.com/realm/SwiftLint) [:star: 17677] - A tool to enforce Swift style and conventions.
...
- [DynamicColor](https://github.com/yannickl/DynamicColor) [:star: 2886] - Yet another extension to manipulate colors easily in Swift.
...
- [CoreStore](https://github.com/JohnEstropia/CoreStore) [:star: 3831] - Powerful Core Data framework for Incremental Migrations, Fetching, Observering, etc.
...
- [WCDB](https://github.com/Tencent/wcdb) [:star: 9777] - WCDB is an efficient, complete, easy-to-use mobile database framework for iOS, macOS.
...
- [MMKV](https://github.com/Tencent/MMKV) [:star: 16125] - An efficient, small mobile key-value storage framework developed by WeChat. Works on iOS, Android, macOS and Windows.
...
- [swift-algorithm-club](https://github.com/raywenderlich/swift-algorithm-club) [:star: 28003] - Algorithms and data structures in Swift, with explanations!
...
- [Flex](https://github.com/Flipboard/FLEX) [:star: 13682] - An in-app debugging and exploration tool for iOS.
...
- [Playbook](https://github.com/playbook-ui/playbook-ios) [:star: 1028] - A library for isolated developing UI components and automatically snapshots of them.
- [DoraemonKit](https://github.com/didi/DoraemonKit) [:star: 19633] - A full-featured iOS App development assistant，30+ tools included. You deserve it.
